...
private:
    ...
    double excStateDMRG(int nsweeps = 8, int maxdim_last = 200, double cutoff = 1E-10, bool quiet = true);

    // Energy analysis
    double energyDensityConvergenceTest() const;
