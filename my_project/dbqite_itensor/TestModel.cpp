...
TestModel::TestModel()
    ...
    phi_ = ITensor(s_);
    phi_.set(s_(1),  1.0 / sqrt(2.0));
    phi_.set(s_(2), -1.0 / sqrt(2.0));
    //phi.set(s(1), 0.0);
    //phi.set(s(2), 1.0);
    ...
    ket0_.set(s_(1), 1.0);
    ket0_.set(s_(2), 0.0);
    //ket0.set(s(1), 1.0/sqrt(2.0));
    //ket0.set(s(2), 1.0/sqrt(2.0));

    checkHamiltonian();
}

void TestModel::checkHamiltonian() const{
...
void TestModel::printSummary() const{
    cout << "Site index: " << s_ << "\n";
    cout << "H = " << H_ << "\n";
    cout << "phi = " << phi_ << "\n";
    cout << "ket0 = " << ket0_ << "\n";
...
void TestModel::basicModelLoop(const AlgoLoopParams& params) const {
    // Parameters
